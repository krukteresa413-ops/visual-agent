...
INDUSTRY_SCENES = [
    ...
    # === P1.4: 10 new industry scenes ===
    {"id": "food_beverage", "name": "食品饮料", "icon": "🥤", "desc": "餐饮零食饮品营销", "platforms": ["taobao", "jd", "douyin", "xiaohongshu"]},
    {"id": "real_estate", "name": "房产家居", "icon": "🏠", "desc": "楼盘装修家具营销", "platforms": ["xiaohongshu", "douyin", "wechat"]},
    {"id": "education", "name": "教育培训", "icon": "📚", "desc": "课程知识付费教辅营销", "platforms": ["xiaohongshu", "douyin", "wechat"]},
    {"id": "automotive", "name": "汽车出行", "icon": "🚗", "desc": "新车二手车汽车用品", "platforms": ["douyin", "xiaohongshu", "taobao"]},
    {"id": "health_wellness", "name": "健康养生", "icon": "💪", "desc": "保健品体检健身营销", "platforms": ["xiaohongshu", "douyin", "taobao"]},
    {"id": "pet_supplies", "name": "宠物用品", "icon": "🐾", "desc": "宠物食品用品服务", "platforms": ["taobao", "xiaohongshu", "douyin"]},
    {"id": "sports_outdoor", "name": "运动户外", "icon": "🏕️", "desc": "运动装备户外用品露营", "platforms": ["taobao", "jd", "xiaohongshu"]},
    {"id": "baby_maternal", "name": "母婴用品", "icon": "🍼", "desc": "婴童用品孕产营销", "platforms": ["taobao", "xiaohongshu", "jd"]},
    {"id": "jewelry_accessories", "name": "珠宝配饰", "icon": "💎", "desc": "首饰手表眼镜配饰", "platforms": ["taobao", "xiaohongshu", "douyin"]},
    {"id": "home_appliances", "name": "家电数码", "icon": "📺", "desc": "大家电小家电数码产品", "platforms": ["taobao", "jd", "douyin"]},
]
