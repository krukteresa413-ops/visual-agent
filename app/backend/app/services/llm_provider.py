...
def _is_retryable(error: Exception) -> bool:
    ...
    # HTTP status code based checks (from OpenAI SDK errors)
    ...
    # Check if any cause in the chain is retryable
...
async def retry_with_backoff(
    ...
    Args:
        ...
        max_retries: Max retry attempts (total calls = 1 + max_retries)
